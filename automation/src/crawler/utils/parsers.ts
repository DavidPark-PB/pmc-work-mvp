...
export function generateProductId(identifier: string): string {
...
/** 평점 파싱: "4.5 / 5" -> 4.5, "★★★★☆" -> 4 */
export function parseRating(ratingText: string | null | undefined): number | undefined {
...
/** 상대 URL → 절대 URL 변환 */
export function toAbsoluteUrl(relativeUrl: string | null | undefined, baseUrl: string): string {
...
/** 재고 상태 파싱 */
export function parseStockStatus(text: string | null | undefined): boolean {
  if (!text) return true;
...
/** 통화 코드 추출 */
export function parseCurrency(priceText: string): string {
